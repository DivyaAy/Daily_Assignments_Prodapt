...
while(True):
    ...
    print("3.DISPLAY ALL DETAILS IN CSV")
    print("4.TO SAVE DATA IN DATABASE")
    print("5.DISPLAY BY SEARCH NAME")
    print("6.TO DELETE ANY DATA")
    print("7.TO UPDATE DATA")
    print("8.SEND QUERY MAIL TO PRODUCER")
    print("9.EXIT")
